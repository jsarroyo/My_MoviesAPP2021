...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView(recyclerView: RecyclerView) {
        recyclerView.adapter = MovieViewAdapter(this, twoPane, recyclerView)
    }

    class MovieViewAdapter(private val parentActivity: MainActivity,
            ...
            onClickListener = View.OnClickListener { v ->
                ...
                if (twoPane) {
                    ...
                    val intent = Intent(v.context, DetActivity::class.java).apply {
                        putExtra("index",mMovie[recyclerView.getChildAdapterPosition(v)].name)
